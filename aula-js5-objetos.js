...
*/
const arrayCarro = [['fabricante', 'Ford'], ['modelo', 'Mustang'], ['ano', 1964]]
...
// }
 ...
 function exercicioCarro(arrayCarro){
    for (let index of arrayCarro){
    carroObj[index[0]] = index[1]
    }
    return carroObj;
}

console.log(exercicioCarro(arrayCarro));

console.log(Object.entries(carroObj));
